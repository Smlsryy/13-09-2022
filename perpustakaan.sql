...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2022 at 08:44 AM
...
(1, 'JAROT PUNYA CERITA', '1234321', 0x646f776e6c6f61642e6a666966),
(2, 'PEDULI DJHAROT', 'hai', 0x646f776e6c6f61642e706e67),
(3, 'NAMA SAYA JAROT', 'PPPPP', 0x706e67747265652d68616e642d7061696e7465642d74656163686572732d6461792d612d737461636b2d6f662d626f6f6b732d626f6f6b2d706e672d696d6167655f333833373630392e6a7067),
(4, 'MISSION ', 'HHHHH', 0x576861747341707020496d61676520323032322d30392d303820617420322e34332e303420504d2e6a706567),
(5, 'JROT JROT JAROT', 'dyROTTTT', 0x576861747341707020496d61676520323032322d30392d303820617420322e34332e303420504d2e6a706567),
(6, 'panji', '1111', 0x576861747341707020496d61676520323032322d30392d303820617420322e34332e303420504d2e6a706567);
...
(23, 'XI RPL 9', 'DJAROT', 12),
(24, 'XI RPL 2', 'PREK', 30),
(25, 'XI RPL 8', 'TIDAR', 30),
(26, 'XI TKJ 4', 'PAROT', 30);
...
INSERT INTO `peminjaman_buku` (`id_peminjaman_buku`, `id_siswa`, `tanggal_peminjaman`, `tanggal_kembali`) VALUES
(1, 50, '2022-09-13', '2022-09-18'),
(2, 50, '2022-09-13', '2022-09-18'),
(3, 50, '2022-09-13', '2022-09-18');
...
(46, 'griyyel', '2006-03-18', 'P', 'tidar', 'smlaryy_', '0c7edce74862ddcc5fb83dcb2cf15bc2', 23),
(47, 'uelll', '2006-05-21', 'L', 'cpu', 'griyyel', '8542516f8870173d7d1daba1daaaf0a1', 24),
(48, 'DJAROT', '2022-09-07', 'L', 'pppppp', 'djarot', '4297f44b13955235245b2497399d7a93', 23),
(49, 'PAROT', '2022-09-07', 'L', 'asdf', 'parot', 'b0baee9d279d34fa1dfd71aadb908c3f', 26),
(50, 'DJAROTTT', '2022-09-08', 'L', 'qwsdf', 'djharot', '698d51a19d8a121ce581499d7b701668', 23);
...
--
ALTER TABLE `peminjaman_buku`
  MODIFY `id_peminjaman_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
