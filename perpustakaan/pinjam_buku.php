...
$qry_detail_buku = mysqli_query($myAdmin, "select * from buku where id_buku = '" . $_GET['id_buku'] . "'");
...
<div class="row">
    <div class="col-md-4">
        <img style="width: 400px; height: 400px; " src="img/<?= $dt_buku['foto'] ?>" class="card-img-top">
    </div>
    <div class="col-md-8">
