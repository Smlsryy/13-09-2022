...
<body>
    ...
    include "navbar.php";
    include "conncet.php";
    $qry_get_siswa = mysqli_query($myAdmin, "select * from siswa where id_siswa = '" . $_GET['id_siswa'] . "'");
    $dt_siswa = mysqli_fetch_array($qry_get_siswa);

    ?>

    <h3 style="margin-left: 8px;">Ubah Siswa</h3>
    <form action="proses_ubah_siswa.php" method="POST" style="margin-left: 8px;">
